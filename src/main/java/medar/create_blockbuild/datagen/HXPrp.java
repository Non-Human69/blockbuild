...
public class HXPrp extends RecipeProvider {

    public HXPrp(PackOutput output) {
        super(output);
    }
    ...
    private void generateMixingRecipe(Consumer<FinishedRecipe> writer, ResourceLocation blockId) {
        ...
        writer.accept(new FinishedRecipe() {
            ...
            public RecipeSerializer<?> getType() {
                return ForgeRegistries.RECIPE_SERIALIZERS.getValue(new ResourceLocation("create", "mixing"));
            }
